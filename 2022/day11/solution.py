...
class Monkey():
    ...
    def __init__(self, items, operation, test, targets, relief, scale_factor):
        self.items = items
    ...
    def handle_item(self, other_monkeys):
        ...
        self.throw(item % self.scale_factor, other_monkeys[target])
...
class Parser():
    ...
    def construct_monkeys(self):
        ...
        for i in range(n):
            ...
            monkey = Monkey(items, operation, test, targets,
                            relief = self.relief,
...
if __name__ == '__main__':
    ...
    check_in = [1, 20, 1000, 2000, 3000, 4000, 5000,
